...
public class Wonderland{
    ...
    public Wonderland(Character character){
        ...
        {"You have reached the Mad Hatters house. It appear there is a tea party in session!", "You have reached the duchesses manner.", "You emerge from the woods into a meadow surrounding a small gabled house. You enter the house, and on the table is a container of pills.", "You enter a grove of massive mushrooms. Your eyes meet those of a caterpillar who ignores you, taking a drag of a long hookah.", "Chilled to the bone, you hurry on through the woods in the hopes of finding shelter."}, 
        ...
        {"You cross the water to find a small door.","You reach the edge of a calm pond. Thirsty, you cup the water to your lips only to spit out a mouthful of tears.","","The forest thickens. A sign points east saying, 'Enter at your own peril!'", "You wander down another one of the Tulgey woods winding purple roads. Will you ever escape?"}};
